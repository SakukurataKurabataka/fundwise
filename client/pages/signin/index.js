          ...
          <div className='w-3/5 p-5'>
            ...
            <div className='py-10'>
              ...
              <div className='flex flex-col items-center'>
                ...
                <a href="#" className='border-2 text-green-500 border-green-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-green-500 hover:text-white'>Sign In</a>
              </div>
            </div>
          </div>{/* Sign in section */}
