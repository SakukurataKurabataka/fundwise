...
module.exports = function base64ToImage(base64Str, path, optionalObj) {
  if (!base64Str || !path) {
    throw new Error(
      "Missing mandatory arguments base64 string and/or path string"
    );
  }
  ...
  var fileName = optionalObj.fileName || "temp";
  var abs;
